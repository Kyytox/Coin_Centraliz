...
class Article(models.Model):
    ...
    category_1 = models.fields.CharField(max_length=15)
    category_2 = models.fields.CharField(max_length=15)
    category_3 = models.fields.CharField(max_length=15)
    category_4 = models.fields.CharField(max_length=15)
